...
return [
    ...
    */
    ...
    'api_key'    => function_exists('env') ? env('NEXMO_KEY', '') : '0293f09d',
    'api_secret' => function_exists('env') ? env('NEXMO_SECRET', '') : 'JwGaOQOK76mt2o0f',
    ...
    */
    ...
    'app' => ['name' => function_exists('env') ? env('NEXMO_APP_NAME', 'NexmoLaravel') : '',
