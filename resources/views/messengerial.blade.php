...
<div class="card">
	<div class="card-header card-header-new">
		<h4 align="center"><span class="fa fa-envelope"></span>&nbsp;Messengerial Requests</h4>
	</div>
	<div class="card-body">
		<div class="row">
			<!-- 1st col -->
				...
				<div class="row">
					<table class="table-sm table table-bordered table-striped searchTable no-footer" id="tickets_table" align="center" role="grid" aria-describedby="tickets_table_info">
						...
						<tbody>
							...
							<tr class="text-center">
								<td>{{$data->subject}}</td>
								<td> <i class="fas fa-paperclip"></i><a href="#">{{$data->control_num}}</a></td>
								<td>{{$data->created_at}}</td>
								<td>{{$data->status}}</td>
								<td>
									<button onclick="_edit('{{$data->id}}')" class="btn btn-info btn-sm"><span class="fa fa-users"></span> recipient portion</button> |
